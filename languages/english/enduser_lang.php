...
$l['vm_lm_change_firewall_plan'] = 'Change Firewall Plan';
...
$l['lst_no_vs'] = 'You do not have any '.VM_SHORT.' in the account';
$l['lst_lv_mb'] = 'MB'; // Need to be removed after new UI is the Default UI
...
$l['svm_done'] = 'The '.VM_SHORT.' was started successfully';
...
$l['stvm_done'] = 'The '.VM_SHORT.' was stopped successfully';
$l['stvm_sub_but'] = 'Stop '.VM_SHORT;
$l['stvm_cur_stat'] = 'Status';
$l['stvm_status_1'] = 'Online';
$l['stvm_status_0'] = 'Offline';
$l['stvm_signal_sent'] = 'The Shutdown signal has been sent to the '.VM_SHORT;
...
$l['re_sub_but'] = 'Restart '.VM_SHORT;
$l['re_cur_stat'] = 'Status';
$l['re_status_1'] = 'Online';
$l['re_status_0'] = 'Offline';
$l['re_signal_sent'] = 'The '.VM_SHORT.' is rebooting';
...
$l['twofactauth_enable_app'] = 'Enable App (Google authenticator etc..)';
...
$l['hn_change_onboot'] = 'Your hostname will be changed when the '.VM_SHORT.' is booted again';
...
$l['ips_change_onboot'] = 'Your IP settings will be changed when the '.VM_SHORT.' is booted again';
...
$l['pr_tax_number'] = 'Enter '.$globals['tax_name'].' number';
$l['pr_tax_number_exp'] = 'If you want your '.$globals['tax_name'].' number on inovice please enter your '.$globals['tax_name'].' ';
...
$l['ser_select'] = 'Select';
$l['ser_vps_is_off'] = 'The '.VM_SHORT.' is off !';
...
$l['proc_vps_is_off'] = 'The '.VM_SHORT.' is off !';
...
$l['pdns_no_server'] = 'Please select the DNS Server';
...
$l['us_copyright_text'] = 'Copyright';
$l['us_copyright_text_exp'] = 'If empty default Copyright will be displayed';
$l['us_policy_url'] = 'Privacy Policy URL';
$l['us_policy_url_exp'] = 'If empty no Privacy Policy will be displayed';
...
$l['li_space_gb'] = 'GB'; // Need to be removed after new UI is the Default UI
$l['li_inodes'] = 'Inodes';
...
$l['li_ram_mb'] = 'MB'; // Need to be removed after new UI is the Default UI
...
$l['li_band_gb'] = 'GB'; // Need to be removed after new UI is the Default UI
...
$l['cpan_change_onboot'] = 'The Panel will be installed when you shutdown and then start the '.VM_SHORT;
...
$l['band_range'] = 'Choose Your Custom Range Here';
...
$l['login_signup'] = 'Dont have an account? ';
$l['login_register'] = 'Sign Up';
...
$l['login_enteremail'] = 'Enter your Email';
...
$l['login_enterotp'] = 'Enter the OTP';
...
$l['bill_transactions'] = 'Transactions';
$l['bill_balance'] = 'Balance as on:';
$l['bill_usage'] = 'Usage';
...
$l['webuzo_spasswd'] = 'Root Password';
...
$l['vol_rate_hour'] = 'Hr';
$l['vol_rate_month'] = 'Mo';
$l['vol_Gb'] = 'GB'; // Need to be removed after new UI is the Default UI
$l['vol_None'] = 'None';
